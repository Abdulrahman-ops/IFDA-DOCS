...
.. image:: ../images/company/sub-types-mlear.png



**ثانيا: ملئ المعلومات الاساسية للموقع التصنيعي وبدء المعاملة**:

.. image:: ../images/company/comp-info-mlear.png
...
3. شهادة ضمان الجودة Quality assurance certificate فعالة ومصدقة:
...
.. image:: ../images/company/qac-fields.png


1. بلد المنشأ لل QAC.

2. الجهه المصدرة لل QAC.

3. تاريخ اصدار ال QAC.
...
4.  ملف دليل الجودة Quality Manual file او ملف الموقع التصنيعي Site Master File يحوي على ختم على جميع الصفحات:
...
7. رسالة الزيارة Invitation Letter يجب طباعة استمارة رسالة الدعوة وتوقيعها وختمها بالختم الحي واعادة رفعها للنظام وتسليمها بنسخة ورقية مع الملف:
...
8. شهادة البيع الحر Free Sell Certificate:
...
10. شهادة التسعيرات Invoice نسخة من شهادة التسعيرة مختومة لدولتين على الاقل:
...
11. استمارة التسجيل للأجهزة الطبية والأطقم التشخيصية المخبرية Registration form For Medical Appliances & Lab Diagnostic kits تحوي ختم وتوقيع مدير الموقع او الشركة على جميع الصفحات:
